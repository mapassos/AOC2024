...
def main():
    ...
    #get all the positions of each type of antennas
    ...
    for ant in ants:
        ...
        for i, coord1 in enumerate(ants[ant]):
            for j in range(i + 1,num_ant):
                ...
                if ant_map[coord1[0]][coord1[1]] != '#':
                    ant_map[coord1[0]][coord1[1]] = '#'
                
                while 0 <= node_xcoord < dim[0] and 0 <= node_ycoord < dim[1]:
                ...
                if ant_map[coord2[0]][coord2[1]] != '#':
                    ant_map[coord2[0]][coord2[1]] = '#'
